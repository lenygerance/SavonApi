...
class RecetteTests (
    ...
    fun setup() {
        ...
        savon = Recette(
            ...
            ligne = mutableListOf(
                Ligne(
                    LigneId(ingredientId = 1, recetteId = 1),
                    quantite = 500f,
                    pourcentage = 50f,
                    ingredient = huileOlive
                ),
                Ligne(
                    LigneId(ingredientId = 2, recetteId = 1),
                    quantite = 500f,
                    pourcentage = 50f,
    ...
    fun `test calculApportEau`() {
        ...
        assertEquals(353.0833f, savon.qteEau, 0.001f, "L'apport en eau doit être calculé correctement")
    }
